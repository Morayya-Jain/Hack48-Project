...
CREATE TABLE profiles (
  ...
  expertise_level text CHECK (expertise_level IN ('beginner', 'intermediate', 'advanced')),
...
-- If you already have old skill levels saved, normalize them:
-- UPDATE projects
...
--   );
--
-- Add constraints to enforce 3 levels going forward:
